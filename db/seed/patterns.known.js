...
export const KNOWN_CASES = [
    {
        ...
        behaviour: 'Two siblings at one address with one guardian declare household incomes of ₹96,000 and ₹1,78,000. One certificate describes the household honestly; the other does not.',
    ...
    },
    {
        ...
        behaviour: 'One guardian appears on two applications filed as separate households at different addresses, declaring ₹89,000 on one and ₹6,40,000 on the other.',
    ...
    },
    {
        ...
        behaviour: 'Four applicants with no shared guardian, phone, or surname give the same address, all declaring incomes below the eligibility ceiling.',
    ...
    },
    {
        ...
        behaviour: 'One household, no relocation on record, holding certificates from two different taluk offices in the same cycle.',
    ...
    },
    {
        ...
        behaviour: 'A household with a genuine income contradiction whose certificates were also obtained days before the deadline. Deadline proximity is meaningless alone; here it has corroboration.',
    ...
    },
    {
        ...
        behaviour: 'Siblings whose father is written in full on one application and as an initial plus surname on the other. Resolution must still merge them for the contradiction to be visible.',
        expectedRules: ['SIBLING_INCOME_CONTRADICTION'],
        shouldFlag: ['f1', 'f2'],
        applications: [
            {
    ...
    },
    {
        ...
        behaviour: 'Three siblings in one household. Two agree at roughly ₹95,000; the third declares ₹1,78,000. The outlier is visible only against its siblings.',
        expectedRules: ['SIBLING_INCOME_CONTRADICTION'],
        shouldFlag: ['g1', 'g2', 'g3'],
        applications: [
            {
...
export const KNOWN_APPLICATION_COUNT = KNOWN_CASES.reduce((n, c) => n + c.applications.length, 0);
export const KNOWN_EXPECTED_FLAG_COUNT = KNOWN_CASES.reduce((n, c) => n + c.shouldFlag.length, 0);
//# sourceMappingURL=patterns.known.js.map