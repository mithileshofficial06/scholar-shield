 ...
 */
export const EQUITY_CASES = [
    {
        id: 'E-01-joint-family-one-address',
        circumstance: 'Three brothers and their families share one ancestral house. Each nuclear family files separately, and each is genuinely poor.',
        behaviour: 'Three separately-resolved households at one address, all below the eligibility ceiling. Indistinguishable from collusion on address alone — which is why the address rule is capped at medium.',
    ...
    },
    {
        ...
        circumstance: 'Two siblings enter college in the same year and obtain their certificates in the same week, because that is when the family did the paperwork.',
        behaviour: 'Certificates issued days apart with fully consistent incomes. The naive reading is "certificate shopping"; the actual reading is one trip to the taluk office.',
        toleratedRules: [],
        applications: [
            {
                ref: 'b1',
    ...
    },
    {
        ...
        circumstance: 'The family moved districts between the two siblings applying. The second certificate necessarily came from a different taluk office.',
        behaviour: 'One household, two issuing offices, consistent incomes. Weighted low precisely because relocation is ordinary.',
    ...
    },
    {
        ...
        circumstance: 'Two certificates for one household issued four months apart, reflecting slightly different assessments of casual daily-wage earnings.',
        behaviour: '₹84,000 against ₹79,000 — a 6% difference on a low income. Real certificates for one household genuinely vary this much.',
        toleratedRules: [],
        applications: [
            {
                ref: 'd1',
    ...
    },
    {
        ...
        circumstance: 'Half-siblings living in different households after a remarriage. Each application names a different, correct guardian.',
        behaviour: 'Shared surname, different guardians, different addresses. Must not be merged into one household — doing so would manufacture a contradiction from two honest filings.',
        toleratedRules: [],
        applications: [
            {
                ref: 'e1',
    ...
    },
    {
        ...
        circumstance: 'A migrant labour family whose address of record is the home village while the household actually lives near the work site. Two siblings gave different addresses, both truthfully.',
        behaviour: 'Same guardian, same phone, different addresses, consistent incomes. Should resolve to one household on guardian plus phone, and find nothing wrong there.',
        toleratedRules: [],
        applications: [
            {
                ref: 'f1',
    ...
    },
    {
        ...
        circumstance: 'A tenement building housing several poor families, who all filed late because the certificates took weeks to come through.',
        behaviour: 'Address clustering AND deadline proximity together. This is the case that tests whether corroboration escalates severity — it must not. Two low-and-medium signals stay two low-and-medium signals.',
...
export const EQUITY_APPLICATION_COUNT = EQUITY_CASES.reduce((n, c) => n + c.applications.length, 0);
//# sourceMappingURL=patterns.equity.js.map